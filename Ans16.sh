...
ASSIGNMENT  :-  2
Q16 - The distance between two cities is input through the keyboard. (in km). Write a program to convert this distance into metres, feet, 
inches and centimetres and display the results.
c
